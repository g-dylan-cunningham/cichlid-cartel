...
const Modal = ({ specie }) => {
  ...
  return (
    ...
    //   style={{inset: 0, paddingTop: '50px'}}
    // >
      <div
        className='fixed inset-0 flex items-center justify-center overflow-x-hidden outline-none focus:outline-none overflow-hidden bg-gray-800'
