...
const ImageUpload = ({ specie, associatedImgs, setAssociatedImgs, setShowModal }) => {
    ...
    <div className="mt-8">
      <form onSubmit={handleSubmit} className="flex justify-between">
        <div className="flex flex-col">
          {!file && <h1 className="mb-2">Choose an image for this species to upload</h1>}
          <input className="mb-6" type="file" accept="image/*" onChange={handleFileChange} />
          <Button
            type="submit"
            variant="primary"
            btnClass=""
